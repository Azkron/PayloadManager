...
2. After the assingments are calcualted it will respond to the POST with the assingments and it will also broadcast both the request and the assingments through a socket connection.
